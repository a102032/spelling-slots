// Spelling Slots offline support.
// You don't need to edit this file when you change index.html:
// boards that are online always load the newest version.
const CACHE = "spelling-slots-v1";
const CORE = [
  "./",
  "./index.html",
